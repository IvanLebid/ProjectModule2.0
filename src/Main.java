...
public class Main {
    public static void main(String[] args) {
        ...
        Rabbit bunny = new Rabbit(random.nextInt(2) + 1, random.nextInt(0, 150), random.nextInt(2) + 1, random.nextDouble() * 0.45);
        System.out.println("Кролика bunny з характеристиками:\nweight: " + bunny.weight + "\t countPerCell: " + bunny.countPerCell + "\tspeedMax: " + bunny.speedMax + "\tfoodWeight: " + bunny.foodWeight + "\nстворено!");
